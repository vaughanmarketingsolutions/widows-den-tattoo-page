...
export const ARTISTS: Artist[] = [
  {
    ...
    portfolio: [
      'https://i.imgur.com/4kpDN4U.png',
      'https://i.imgur.com/MBVw5BA.png',
      'https://i.imgur.com/okLnINJ.png',
    ],
    themeColor: 'orange',
    instagram: 'https://www.instagram.com/ryn_ink/',
    facebook: 'https://www.facebook.com/ryn.gori#',
  },
  {
    id: 'jeperti',
    name: 'Jeperti',
    ...
    portfolio: [
      'https://i.imgur.com/JVu3IP7.png',
      'https://i.imgur.com/V9GqYu2.png',
      'https://i.imgur.com/Jb6zS0i.png',
    ],
    themeColor: 'teal',
    facebook: 'https://www.facebook.com/jeperti.judge',
  },
];
